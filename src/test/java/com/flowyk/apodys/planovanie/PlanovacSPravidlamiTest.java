...
public class PlanovacSPravidlamiTest {
    ...
    public void testNaplanuj() throws Exception {
        ...
        planovac.pridat(new PravidloVolnoPoSmene(td.predlohaN2P.getTyp(), Duration.ofHours(12L)));
        planovac.pridat(new PravidloVolnoPoSmene(td.predlohaR2P.getTyp(), Duration.ofHours(1L)));
        planovac.pridat(new PravidloVolnoPoDvochSmenach(td.predlohaN2P.getTyp(), td.predlohaN2P.getTyp(), Duration.ofHours(48L)));
